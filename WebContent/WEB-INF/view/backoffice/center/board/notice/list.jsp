	...
	<section class="right_col">
		<article class="x_panel">
			...
			<div class="brdInfo">
				...
				<div class="col-md-3 col-sm-3 col-xs-3 pull-right"> 공지사항 관리 </div>
			</div>
			...
			<br/><br/>
			<div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
				<a href="/console/center/board/writeForm.web?cd_bbs_type=1" class="btn btn-round btn-primary">글쓰기</a>
			</div>
		</article>
		<aside></aside>
	</section>
