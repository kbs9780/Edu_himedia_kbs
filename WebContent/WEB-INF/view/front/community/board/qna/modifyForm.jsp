...
<head>
	...
	function goList() {
		...
		redirectUrl = "/front/community/board/list.web?cd_bbs_type= 8";
	...
	<div class="content">
		...
		<article class="txtCenter">
				...
				<tr>
					...
					<div class="category-container">
						<select id="cd_bbs_type" name="cd_bbs_type" required>
							<option value="8" <c:if test="${communityDto.cd_bbs_type == 	'8'}"> selected</c:if>>질문하기</option>
						</select>
						&nbsp;&nbsp;&nbsp;
			...
			<div style="display: flex; justify-content: center; width: 70%; margin-left: auto; margin-right: auto;">
				<button type="button" class="submit-btn" style="margin-right: 10px; font-size: 0.9rem; width:25%; height:60px;" onclick="goList(8);">목록</button>
				<button type="button" class="submit-btn"style="margin-right: 10px; font-size: 0.9rem; width:25%; height:60px;" onclick="modifyProc(8);">수정하기</button>
			</div>
		</article>
		<aside></aside>
	</section>
