	...
	<section class="content">
		...
		<table class="headLeft_01">
			...
			<div style="display: flex; justify-content: right; margin-top: 20px;">
				<input type="button" value="목록" style="width:15%; height:60px;" onclick="javascript:goList(9);" />
				<input type="button" value="수정" style="width:15%" onclick="javascript:modifyForm(9);" /> 
