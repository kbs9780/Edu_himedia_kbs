...
<head>
	...
	function goList() {
		...
		redirectUrl = "/front/community/board/list.web?cd_bbs_type= 9";
	...
	<div class="content">
		...
		<article class="txtCenter">
			...
			<div style="display: flex; justify-content: center; width: 70%; margin-left: auto; margin-right: auto;">
				<button type="button" class="submit-btn" style="margin-right: 10px; font-size: 0.9rem; width:25%; height:60px;" onclick="goList(9);">목록</button>
				<button type="button" class="submit-btn"style="margin-right: 10px; font-size: 0.9rem; width:25%; height:60px;" onclick="modifyProc(9);">수정하기</button>
			</div>
		</article>
		<aside></aside>
	</section>
