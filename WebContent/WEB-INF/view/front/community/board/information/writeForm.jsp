...
<%@ page info="/WEB-INF/view/front/community/board/information/writeForm.jsp" %>
			...
			<section class="content">
				<article class="txtCenter">
					...
					<div style="display: flex; justify-content: center; width: 70%; margin-left: auto; margin-right: auto;">
						<button type="button" class="submit-btn" style="margin-right: 10px; font-size: 0.9rem;" onclick="goList(11);">목록</button>
						<button type="button" class="submit-btn" onclick="writeProc(11);">게시글 작성</button>
					</div>
				</article>
			</section>
			<footer>
