...
<div class="container">
	...
	<article style="flex: 1; padding-right: 20px;">
		<img src="/images/adap_about.png" alt="입양안내 이미지" style="width: 60%; height: 100%; object-fit: cover; float: center; margin-left: 150px; margin-bottom: 10px; margin-top: 20px;"/>
	</article>
</section>
	<footer>
