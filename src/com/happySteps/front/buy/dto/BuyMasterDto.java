 ...
 *				: [20241004122401][rkdcodbs77#naver.com][CREATE: Initial Release]
 */
...
public class BuyMasterDto {
	...
	private int rnum					= 0; 	// 행번호
	private int seq_buy_mst			= 0; 	// 구매 마스터 일련번호
	private int seq_mbr				= 0; 	// 회원 일련번호
	private String buy_info				= ""; 	// 구매상품정보
	private int buy_count				= 0; 	// 구매상품 총 갯수
	private int buy_price				= 0;	// 구매상품 총 금액
	private String flg_delete			= ""; 	// 상품 삭제여부
