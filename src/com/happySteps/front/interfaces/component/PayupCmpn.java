 ...
 *				: [20241018170000][pluto@himedia.co.kr][REPORT: From com.payup.pay.service.ApiService New(BASE ON TOKEN)]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Component("com.happySteps.front.interfaces.component.PayupCmpn")
public class PayupCmpn {
	...
	public Map<String,Object> JsonApi(HttpServletRequest requests, String url, Map<String, String> map, String Authorization) {
		...
		if (com.happySteps.util.servlet.Request.isDevice(requests, "mobile")) {
