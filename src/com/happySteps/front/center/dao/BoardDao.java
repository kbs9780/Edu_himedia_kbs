 ...
 *				: [20240704164134][pluto#himedia.co.kr][CREATE: Initial Release]
 */
package com.happySteps.front.center.dao;
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("com.happySteps.front.center.dao.BoardDao")
public class BoardDao extends BaseDao {
	...
	public BoardDto selectReply(BoardDto boardDto) {
		return sqlSessionFront.selectOne("com.happySteps.front.mybatis.center.Board.selectReply", boardDto);
	}
	

	 public int count(PagingDto pagingDto) { return
	 sqlSessionFront.selectOne("com.happySteps.front.mybatis.center.Board.count",
	 pagingDto); }
	...
	public int delete(BoardDto boardDto) {
		return sqlSessionFront.delete("com.happySteps.front.mybatis.center.Board.delete", boardDto);
	}
	...
	public int insert(BoardDto boardDto) {
		return sqlSessionFront.insert("com.happySteps.front.mybatis.center.Board.insert", boardDto);
	}
	...
	public int deleteFlag(BoardDto boardDto) {
		return sqlSessionFront.update("com.happySteps.front.mybatis.center.Board.deleteFlag", boardDto);
	}
	...
	public int update(BoardDto boardDto) {
		return sqlSessionFront.update("com.happySteps.front.mybatis.center.Board.update", boardDto);
	}
	...
	public BoardDto select(BoardDto boardDto) {
		...
		return sqlSessionFront.selectOne("com.happySteps.front.mybatis.center.Board.select", boardDto);
	...
	public List<BoardDto> list(PagingDto pagingDto) {
		...
		return sqlSessionFront.selectList("com.happySteps.front.mybatis.center.Board.list", pagingDto);
	...
	public int sequence() {
		return sqlSessionFront.selectOne("com.happySteps.front.mybatis.center.Board.sequence");
	}
